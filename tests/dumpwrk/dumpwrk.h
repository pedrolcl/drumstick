...
using namespace drumstick;
  ...
  public slots:
    ...
    void globalVars();
    void noteEvent(int track, int time, int chan, int pitch, int vol, int dur);
    void keyPressEvent(int track, int time, int chan, int pitch, int press);
    void ctlChangeEvent(int track, int time, int chan, int ctl, int value);
    void pitchBendEvent(int track, int time, int chan, int value);
    void programEvent(int track, int time, int chan, int patch);
    void chanPressEvent(int track, int time, int chan, int press);
    void sysexEvent(int track, int time, int bank);
    ...
    void textEvent(int track, int time, int typ, const QString& data);
    void timeSigEvent(int bar, int num, int den);
    void keySigEvent(int bar, int alt);
    void tempoEvent(int time, int tempo);
    ...
    void segment(int track, int time, const QString& name);
    void chord(int track, int time, const QString& name, const QByteArray& data);
    void expression(int track, int time, int code, const QString& text);
