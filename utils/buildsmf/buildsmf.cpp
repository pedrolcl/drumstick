/*
    ...
    Copyright (C) 2006-2016, Pedro Lopez-Cabanillas <plcl@users.sourceforge.net>
...
void QSMFBuilder::trackHandler(int )
{
    ...
    m_engine->writeMetaEvent(0, copyright_notice, 
        QString::fromUtf8("Copyright (C) 2006-2016 Pedro López-Cabanillas"));
    ...
    QByteArray gsreset = QByteArray::fromHex("f04110421240007f0041f7");
